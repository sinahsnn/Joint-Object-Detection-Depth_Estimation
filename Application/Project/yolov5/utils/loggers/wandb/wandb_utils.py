...
class WandbLogger():
    ...
    def val_one_image(self, pred, predn, path, names, im):
        """
        Log validation data for one image. updates the threshold_label Table if validation dataset is uploaded and log bbox media panel
    ...
    def end_epoch(self, best_result=False):
        ...
        arguments:
        best_result (boolean): Boolean representing if the threshold_label of this evaluation is best or not
        """
        if self.wandb_run:
            ...
            if self.result_artifact:
                self.result_artifact.add(self.result_table, 'threshold_label')
